...
function writemessage(){
		...
		document.getElementById('js-message').innerHTML ='<ul style="padding-left: 0px;"><textarea placeholder="Message" name="message" maxlength="1000" rows="20" style="width: 100%; max-width: 100%; height: 100%; margin: -19px 0px 0px -1px; padding: 19px 5px 0px 34px; border: 0px; border-right: 1px dashed #B4B4B4; background-color: transparent; font-size: 12px; font-weight: normal; font-family: helvetica; line-height: 15px; text-align: justify;" ></textarea></ul>';
		};

function button(){
		document.getElementById('js-button').style.background='#329AEB';
